...
public enum ConstantsString {
	ADMIN_MEMBER_NO("M000001", "어드민 회원 번호"),
	...
	MESSAGE_ALERT_PARTY_SHIPPING_COMPLETE_MEMBER("쇼핑몰에서 상품이 도착했습니다. 파티장과 협의해서 물품을 수령해 주세요.", "쇼핑몰 배송 완료 알림(파티원)"),
	MESSAGE_ALERT_PARTY_SHIPPING_COMPLETE_LEADER("배송이 완료되었습니다. 파티원들과 협의해서 물품을 전달해 주세요.", "쇼핑몰 배송 완료 알림(파티장)"),
