...
-- 3. 기본 데이터 삽입
INSERT IGNORE INTO
	type_code (type_code, code_group, code_group_sub, code_description)
VALUES
    ('T010101', '회원', '로그인', '자사몰'),
    ('T010102', '회원', '로그인', '네이버'),
    ('T010103', '회원', '로그인', '구글'),
...
INSERT IGNORE INTO
    status_code (status_code, code_group, code_group_sub, code_description)
VALUES
    ('S010101', '회원', '목록', '정상'),
    ('S010102', '회원', '목록', '휴면'),
    ('S010103', '회원', '목록', '제재'),
...
INSERT IGNORE INTO
    member_level (m_level, m_level_name)
VALUES
    (1, '일반이용자'),
    (2, '관리자');

INSERT IGNORE INTO
    category (c_code, c_group1, c_group2, c_group3)
VALUES
    ('CF0101', '식품', '신선식품', '채소'),
    ('CF0102', '식품', '신선식품', '과일'),
...
VALUES
    ('M00000001', 2, 'admin', 'admin', '관리자', 'admin@example.com', '010-9876-5432', 'F', '서울시 강북구', '1985-05-05', '관리자', 'S010101'),
    ('M00000002', 1, 'user2', 'password2', '홍길동', 'hong@example.com', '010-1234-5678', 'M', '서울시 강남구', '1980-01-01', '길동', 'S010101'),
    ('M00000003', 1, 'user3', 'password3', '이순신', 'lee@example.com', '010-5678-1234', 'M', '서울시 중구', '1975-03-15', '순신', 'S010102'),
    ('M00000004', 1, 'user4', 'password4', '김유신', 'kim@example.com', '010-1111-2222', 'M', '경기도 성남시', '1982-02-10', '유신', 'S010101'),
    ('M00000005', 1, 'user5', 'password5', '박혁거세', 'park@example.com', '010-3333-4444', 'M', '부산시 해운대구', '1979-05-15', '혁거세', 'S010101'),
    ('M00000006', 1, 'user6', 'password6', '강감찬', 'kang@example.com', '010-5555-6666', 'M', '광주시 남구', '1985-08-20', '감찬', 'S010102'),
    ('M00000007', 1, 'user7', 'password7', '을지문덕', 'ulji@example.com', '010-7777-8888', 'M', '대구시 중구', '1983-03-03', '문덕', 'S010101'),
    ('M00000008', 1, 'user8', 'password8', '연개소문', 'yeon@example.com', '010-9999-0000', 'M', '대전시 서구', '1984-04-04', '개소문', 'S010103'),
    ('M00000009', 1, 'user9', 'password9', '계백', 'gye@example.com', '010-1212-3434', 'M', '울산시 북구', '1980-05-05', '백', 'S010104'),
    ('M00000010', 1, 'user10', 'password10', '최영', 'choi@example.com', '010-5656-7878', 'M', '충주시 충주읍', '1981-06-06', '영', 'S010101');
